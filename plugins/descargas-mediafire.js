...
let handler = async (m, { conn, args, usedPrefix, command }) => {
  ...
  try {
    ...
    try {
      ...
      console.log('✖️ API 1 falló:', e1.message)
    }
    try {
    ...
    try {
      ...
      console.log('✖️ Scraping falló:', e4.message)
    }

    await m.react('✖️')
    return await conn.reply(m.chat, '✖️ No se pudo descargar el archivo. Intenta más tarde o verifica el enlace.', m)
